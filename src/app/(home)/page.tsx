  ...
  const onSubmit = (data: FormValues) => {
    const invoice: InvoiceData = {
      shifts: {
        ...
        b: {
          sale: parseFloat(data.shifts.b.sale),
          evc: parseFloat(data.shifts.b.evc),
          add: parseFloat(data.shifts.b.evc) - parseFloat(data.shifts.b.sale),
          taka: parseFloat(data.shifts.b.sale) * 43,
        },
        c: {
          sale: parseFloat(data.shifts.c.sale),
          evc: parseFloat(data.shifts.c.evc),
          add: parseFloat(data.shifts.c.evc) - parseFloat(data.shifts.c.sale),
          taka: parseFloat(data.shifts.c.sale) * 43,
        },
      },

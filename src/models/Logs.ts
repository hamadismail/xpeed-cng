...
const logSchema = new mongoose.Schema(
  {
    ...
    cngPrice: { type: Number, default: PRICES.CNG },
    dieselPrice: { type: Number, default: PRICES.DIESEL },
    octanePrice: { type: Number, default: PRICES.OCTANE },
    lpgPrice: { type: Number, default: PRICES.LPG },
